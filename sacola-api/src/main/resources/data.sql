...
(2L, '0000003', 'Complemento Endereço Restaurante 3', 'Restaurante 3');

INSERT INTO cliente (id, cep, complemento, nome) VALUES
(1L, '0000001', 'Complemento Endereço Cliente 1', 'Cliente 1');
(1L, '0000002', 'Complemento Endereço Cliente 2', 'Cliente 2');
(1L, '0000003', 'Complemento Endereço Cliente 3', 'Cliente 3');
